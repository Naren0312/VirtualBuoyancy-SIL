# Hammerhead ROV Software-in-the-Loop (SIL) Simulator Guide

Welcome to the documentation for the Hammerhead ROV Software-in-the-Loop (SIL) simulator. This guide details what was built, how the underlying mathematics and algorithms function, how to operate the simulation environment, and how to configure or tune the system.
